...
with open('mydata/data/local/lm/words.txt', 'r') as f:
    phone = {}; rephone = {}
    for line in f:
        line = line.split()
...
class SequentialLoader:
    def __init__(self, dtype, batch_size=1, attention=False):
        self.labels = {}
        self.feats_rspecifier = 'ark:copy-feats scp:amharic/data/{}/feats.scp ark:- | apply-cmvn --utt2spk=ark:amharic/data/{}/utt2spk scp:amharic/data/{}/cmvn.scp ark:- ark:- |\
 add-deltas --delta-order=2 ark:- ark:- | nnet-forward amharic/data/final.feature_transform ark:- ark:- |'.format(dtype, dtype, dtype)
        self.batch_size = batch_size
        # load label
        with open('amharic/data/'+dtype+'/train_text', 'r') as f:
            for line in f:
                line = line.split()

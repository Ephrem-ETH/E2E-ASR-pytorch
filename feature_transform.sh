...
splice=0
train_feats='ark:copy-feats scp:mydata/data/train/feats.scp ark:- | apply-cmvn --utt2spk=ark:mydata/data/train/utt2spk scp:mydata/data/train/cmvn.scp ark:- ark:- | add-deltas --delta-order=2 ark:- ark:- |'
...
compute-cmvn-stats ark:- - | cmvn-to-nnet --std-dev=1.0 - -| nnet-concat --binary=false $feature_transform - 'mydata/data/final.feature_transform'
